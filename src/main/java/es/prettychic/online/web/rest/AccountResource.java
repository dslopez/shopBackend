...
import es.prettychic.online.domain.PersistentToken;
import es.prettychic.online.domain.User;
import es.prettychic.online.repository.PersistentTokenRepository;
import es.prettychic.online.repository.UserRepository;
import es.prettychic.online.security.SecurityUtils;
import es.prettychic.online.service.MailService;
import es.prettychic.online.service.UserService;
import es.prettychic.online.service.dto.UserDTO;
import es.prettychic.online.web.rest.vm.KeyAndPasswordVM;
import es.prettychic.online.web.rest.vm.ManagedUserVM;
import es.prettychic.online.web.rest.util.HeaderUtil;
